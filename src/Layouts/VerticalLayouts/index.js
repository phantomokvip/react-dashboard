...
const VerticalLayout = (props) => {
    ...
    useEffect(() => {
        ...
        const initMenu = () => {
            ...
            let matchingMenuItem = itemsArray.find((x) => {
                ...
                return ((x.getAttribute('href')).replace('/','') ===  path[1]) || (path[1] == "attendance" && (x.getAttribute('href')).replace('/','') == 'shift');
            });
    ...
    }, [props.location.pathname, props.layoutType, navData]);
                                                                                                ...
                                                                                                <ul className="nav nav-sm flex-column">
                                                                                                    {childItem.childItems.map((subChildItem, key) => (
                                                                                                        <li className="nav-item" key={key}>
                                                                                                            <Link to={subChildItem.link} className="nav-link" data-key="t-basic-action">{props.subChildItem.label} </Link>
                                                                                                        </li>
                                                                                                    ))}
                                                                                                </ul>
                                                                                            </Collapse>
